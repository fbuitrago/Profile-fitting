...
def config_different_fields_no_headers(galaxy,camera):
    ...
    if camera == 'ACS':
        ...
        if galaxy.find("goodss") != -1:
            ...
            zeropoint = 25.96
            #exptime = 1.
            stars = np.array(["tiny_tim_iband"],dtype=str) #don't add extension .fits
    elif camera == 'WFC3':
    ...
    return(zeropoint, pixel_scale, stars)
